...
$ovffile = "S:\MikeF\VCAC 6.1 GA\VMware-Identity-Appliance-2.1.0.0-2007605_OVF10.ova"
...
$ovfconfig.Common.vami.hostname.Value = "vcacsso61.lab.local"
$ovfconfig.Common.varoot_password.Value = "VMware1!"
$ovfconfig.Common.va_ssh_enabled.Value = "True"
$ovfconfig.vami.VMware_Identity_Appliance.DNS.Value = "192.168.1.10"
$ovfconfig.vami.VMware_Identity_Appliance.gateway.Value = "192.168.1.1"
$ovfconfig.vami.VMware_Identity_Appliance.ip0.Value = "192.168.1.26"
$ovfconfig.vami.VMware_Identity_Appliance.netmask0.Value = "255.255.255.0"
